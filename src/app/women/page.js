        ...
        <div className='hidden lg:flex lg:w-full'>
            <div className='lg:flex lg:w-2/3 2xl:w-2/3 mx-auto justify-between lg:pt-10 lg:pb-8 xl:pt-16 xl:pb-12 2xl:py-12'>
              ...
              <div className=' text-zinc-400 flex w-1/3 justify-end items-center '>
                {/* MAGNIFYING GLASS */}
                <svg onClick={() => setIsSearchVisible(true)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="size-7 xl:size-8 mt-1 mr-6 cursor-pointer">
            ...
            <div className='border-b-2 border-zinc-200 w-full flex text-zinc-600' style={{height:60}}>
              <div className='flex justify-between items-center px-5' style={{width:size.width-60}}>
                  ...
                  <div className='flex mt-1 md:mt-0.5'>
                    {/* MAGNIFYING GLASS */}
                    <svg onClick={() => setIsSearchVisible(true)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 mr-4 cursor-pointer">
                      <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                    </svg>
                    {/* HEART */}
                    <Link href={"/favourites"}>
